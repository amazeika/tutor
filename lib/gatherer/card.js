(function() {
  ...
  module.exports = function(details, callback) {
    ...
    }, request.$$(callback, function(html) {
      return extract(html, details);
    }));
  };
  ...
  extract = function(html, details) {
    ...
    _ref3 = /^Rating:(\d(?:[.]\d+)?)\/5[(](\d+)votes?[)]$/.exec($('.textRating').text().replace(/\s+/g, '')).slice(1), rating = _ref3[0], votes = _ref3[1];
